                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <ol class="breadcrumb">
                                            <li><a href="{{url('/jobposts')}}">Home</a></li>
                                            <li class="active"><span>Jobs</span></li>
                                        </ol>
                                        <h1>Jobs Posted <small>http://asiawriters.com</small></h1>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="main-box clearfix">
                                            <header class="main-box-header clearfix">
                                                ...
                                                <div class="col-lg-3 col-sm-1 col-xs-1">
                                                    <div class="main-box infographic-box colored emerald-bg">
                                                        ...
                                                        <span class="value">{{$countsize}}</span>
                                                    </div>
                                            ...
                                            <div class="main-box-body clearfix">
                                                ...
                                                <table class="table footable toggle-circle" data-page-size="20" data-filter="#filter" data-filter-text-only="true">
                                                    <thead>
                                                        <tr>
                                                            <th>Index</th>
                                                            <th>Job ID</th>
                                                            ...
                                                            <th data-hide="all" class="text-right">Processed</th>
                                                            <th data-hide="all" class="text-right">Description</th>
                                                        </tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="editable editable-click"> 
                                                                {{$index->description}}
                                                            </td>
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <ul class="dropdown-menu" role="menu">
                                                                        <li><a href="{{url("/approvals/$index->idx")}}">Edit</a></li>
                                                                        <li class="divider"></li>
                                                                        <li><a href="{{url("/delete_posts/$index->idx")}}">Delete</a></li>
                                                                        <li class="divider"></li>
                                                                        <li><a href="{{url("/approve_posts/$index->idx")}}">Approve</a></li>
